...
> DEPRECATED IMAGE
>
> `Always follow the party master` option is added to `Auto party settings` subsection

![tab-party#auto-party](https://user-images.githubusercontent.com/88906665/183354014-67b4b9cf-4fe5-408f-9d7f-9a2144e42a16.png)

> [!WARNING]
> Bot will try to send invitations even if the party is full and to job players.
...
> DEPRECATED IMAGE
>
> `Whisper` and `Auto Match` has functionality now
