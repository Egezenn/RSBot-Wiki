...
> [!WARNING]
> Unlike other old bots you don't have to have multiple bot folders each containing the bot software's contents. Instead there is a profile system which allows you to do the same thing.
